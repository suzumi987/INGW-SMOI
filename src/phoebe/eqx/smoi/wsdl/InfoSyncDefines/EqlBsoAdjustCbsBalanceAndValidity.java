...
public class EqlBsoAdjustCbsBalanceAndValidity {
	...
	private List<BSONOBalanceAndValidity> bsono;
	
	public List<BSONOBalanceAndValidity> getBSONOBalanceAndValidityListItem() {
        if (bsono == null) {
        	bsono = new ArrayList<BSONOBalanceAndValidity>();
        }
        return this.bsono;
    }
	...
	public List<BSONOBalanceAndValidity> getBsono() {
		return bsono;
	}
	public void setBsono(List<BSONOBalanceAndValidity> bsono) {
		this.bsono = bsono;
	}
