...
public class EqlBsoAdjustCbsValidity<T> {
	...
	private List<T> bsono;
	
	public List<T> getBSONOListItem() {
        if (bsono == null) {
        	bsono = new ArrayList<T>();
        }
        return this.bsono;
    }
	...
	public List<T> getBsono() {
		return bsono;
	}
	public void setBsono(List<T> bsono) {
		this.bsono = bsono;
	}
