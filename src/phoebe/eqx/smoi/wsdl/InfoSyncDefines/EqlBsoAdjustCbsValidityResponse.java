...
public class EqlBsoAdjustCbsValidityResponse {
	...
	private List<BSONOResponse> bsono; //old type BSONOResponse
	
	public List<BSONOResponse> getBSONOListItem() {
        if (bsono == null) {
        	bsono = new ArrayList<BSONOResponse>();
        }
        return this.bsono;
    }
	...
	public void setRequestid(String requsetid) {
	...
	public List<BSONOResponse> getBsono() {
		return bsono;
	}
	public void setBsono(List<BSONOResponse> bsono) {
		this.bsono = bsono;
	}
