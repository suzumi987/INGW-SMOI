...
public class BSONOBalanceAndFree {
	...
	private List<AdjustmentinfolistBalance> adjustmentinfolist;
	// 2018/04/18
	...
	public List<AdjustmentinfolistBalance> getAdjustmentinfolistBalanceListItem() {
        if (adjustmentinfolist == null) {
        	adjustmentinfolist = new ArrayList<AdjustmentinfolistBalance>();
        }
	...
	public List<AdjustmentinfolistBalance> getAdjustmentinfolist() {
		return adjustmentinfolist;
	}
	public void setAdjustmentinfolist(List<AdjustmentinfolistBalance> adjustmentinfolist) {
	...
	public void setInsufficientFlag(String insufficienFlag) {
		this.insufficientFlag = insufficienFlag;
	}
