 ...
 *       &lt;sequence>
 *         &lt;element name="NotifyOperList_Item" type="{http://www.asiainfo.com/obd/InfoSyncDefines.obd}NotifyOper" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "NotifyOperList", namespace = "http://www.asiainfo.com/obd/InfoSyncDefines.obd", propOrder = {
    "notifyOperListItem"
})
public class NotifyOperList {

    @XmlElement(name = "NotifyOperList_Item", namespace = "http://www.asiainfo.com/obd/InfoSyncDefines.obd")
