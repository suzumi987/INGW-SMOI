 ...
 *       &lt;sequence>
 *         &lt;element name="PaymentLogList_Item" type="{http://www.asiainfo.com/obd/CommonComponents.obd}PaymentLog" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PaymentLogList", namespace = "http://www.asiainfo.com/obd/CommonComponents.obd", propOrder = {
    "paymentLogListItem"
})
public class PaymentLogList {

    @XmlElement(name = "PaymentLogList_Item", namespace = "http://www.asiainfo.com/obd/CommonComponents.obd")
